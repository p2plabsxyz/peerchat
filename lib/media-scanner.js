...
// Kept in step with isImageFile and isVideoFile in app.js.
const IMAGE_EXT = /\.(?:avif|gif|heic|heif|jpe?g|png|webp)$/i;
const VIDEO_EXT = /\.(?:3gp|avi|m4v|mkv|mov|mp4|ogg|webm)$/i;
